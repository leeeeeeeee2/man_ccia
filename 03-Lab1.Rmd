...
_Last update: `r system("git log -1 --format=\"%ad (%h)\" -- 03-Lab1.Rmd")`_
...
This will download the individual year-by-year _csv_ files for daily data at Toronto, crop the first 24 lines from them, and the glue them all together in a single file. In this case. That file is called "_`r list.files(pattern = "5051.*csv")`_".
