...
```{r l2f2, echo=FALSE, fig.cap="GFCI group registration for CMIP5 research."}
...
```{r l2f3, echo=FALSE, fig.cap="ESGF main data search page."}
...
```{r l2f4, echo=FALSE, fig.cap="Example ESGF search results."}
...
```{r l2f5, echo=FALSE, fig.cap="ESGF data cart."}
...
```{r l2f6, echo=FALSE, fig.cap="ESGF data cart filtering."}
