...
- Download at least two NetCDF files to your computer (one historical file and once "forced" file from the same model). What are the filenames? Describe the steps that you took to download the file, e.g. what filters did you use? [2 marks]
