...
```{python l4f2, deco=list(), results='hold', fig.cap="Baseline and future summer cooling degree days (CDD) at Toronto. Projections are based on changes to mean temperature forecast by three GCMs under the RCP4.5 and RCP8.5 scenarios."}
