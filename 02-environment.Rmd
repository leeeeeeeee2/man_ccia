...
The Linux distribution that you install should include `bash` and `wget`. Refer to the ["Installing on Linux"](@envinstlin) section, below, to confirm. 
...
If you are running a 64-bit version of Linux, you can install via conda using the following commands:
...
If you installed R directly, you can install via `devtools`, which we installed when we installed `IRkernel`.
