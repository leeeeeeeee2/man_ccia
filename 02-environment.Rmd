...
<div class="decocode"><div style="background-color:#000000"><p><span style="font-size:90%;color:#ffffff"><i class="fas fa-terminal"></i> <b>Shell</b></span></p>
    ...
    conda create -n "man_ccia" "python>=3.7.1" ec3 matplotlib netCDF4 pandas requests "seaborn>=0.9.0"
</div></div>
...
```{shell, eval=FALSE, deco=list(label="PowerShell", bc="#0872c4", tc="#ffffff", icon=list(style="fab", name="windows"))}
...
```{shell, eval=FALSE, deco=list(label="cmd.exe", bc="#000000", tc="#ffffff", icon=list(style="fab", name="windows"))}
# Install Chocolately
