...
```{block, type='rmdtip'}
If you want to run all of the code used in this book, you can install a copy of the environment used by running **`conda env create ConorIA/man_ccia`**. That will install all of the packages that were used in this book!
```
