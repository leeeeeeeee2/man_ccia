...
```{python l3f2, deco=list(), results='hold', fig.cap="Somewhere in here is the CanESM2 Monthly $T_\\mathrm{mean}$ at Toronto (2006‒2040) using three RCP scenarios, but it looks like we need some more sophisticated code to plot this!."}
df.plot()
```
