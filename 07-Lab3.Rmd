...
- In the table above, the baseline temperature forced by the RCP 2.6 scenario is _higher_ than that of the RCP 8.5 scenario. How can the "best case scenario" be warmer than the "worst case"? Explain this, making reference to the "narrative" quality of the RCP scenarios. [2 marks]
