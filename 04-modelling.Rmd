...
The hierarchy of climate models is defined by the number of dimensions represented in the model, that is, the number of climate system components that the model examines. Models can have between zero to three dimensions, which we will briefly define here. 
