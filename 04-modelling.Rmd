...
If you would like to see some examples of the four RCPs and climate model data, poke around the "plots" tab of [_Conjuntool_](https://shiny.conr.ca/conjuntool/), which we will be using in upcoming labs. In Lab 2 (\@ref(lab2)), you will learn how obtain these data from the Earth System Grid Federation (ESGF). In Lab3 (\@ref(lab3)), we will learn to read the data form these files. 
