...
```{r l5f1, echo=FALSE, fig.cap="Toronto $T_\\mathrmean}$ (1981\u20122100), comparison between observed station data (yellow) and simulation by a multimodel ensemble using downscaled GCM data."}
...
```{r l5f2, echo=FALSE, fig.cap="Toronto $T_\\mathrmin}$ (1981\u20122100), comparison between observed station data (yellow) and simulation by a multimodel ensemble using downscaled GCM data."}
...
```{r l5f3, echo=FALSE, fig.cap="Toronto $T_\\mathrmax}$ (1981\u20122100), comparison between observed station data (yellow) and simulation by a multimodel ensemble using downscaled GCM data."}
...
```{r l5f4, echo=FALSE, fig.cap="$T_\\mathrmean}$ bias in downscaled multi-model ensemble using downscaled GCM data. The ensemble mean is shown as a black line. Shaded regions indicate one standard deviation (light grey), and the full range of individual ensemble-members (dark grey)."}
