...
Throughout the course of this book, you will learn how to acquire observed historical climate data from Environment and Climate Change Canada, and perform basic analyses of a climatic exposure unit and meteoroligical variables (Lab 1; Sec. \@ref(lab1)). In Lab 2 (Sec. \@ref(lab2)), you will also learn how to acquire raw GCM data from the Earth System Grid Federation (ESGF), the source for data from the Coupled Model Intercomparison Project Phase 5 (CMIP5). We will show you have to navigate these data sets, and extract the information that is relevant to your analysis (Lab 3, Sec. \@ref(lab3)). In Lab 4 (Sec. \@ref(lab4)), you will use these data to project changes in your exposure unit through the year 2100. Finally, in lab 5 (Sec. \@ref(lab5)), we will show you how to acquire statistically downscaled climate data for Canada (Sec. \@ref(pcic)), and we will use that data to improve our CCIA projections.
