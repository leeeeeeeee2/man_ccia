...
# FIXME: As of the time of writing, using non-zero time_start indeces causes issues
...
<center> `https://data.pacificclimate.org/data/downscaled_gcms/data/<datasetid>.nc?<variable>[<time range>][<lon range>][<lat range>]` </center>
